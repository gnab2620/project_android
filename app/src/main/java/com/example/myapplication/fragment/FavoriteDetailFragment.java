...
//        toolbar = view.findViewById(R.id.toolbar);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        list.add(new Article(R.drawable.linhlinh,"Nhiều người dùng Instagram đang bỏ lỡ tính năng cực kỳ thú vị này!","thai bang 1","02/01/2000"));
        list.add(new Article(R.drawable.linhlinh,"Hố nợ nần sâu thẳm chẳng khác gì Squid Game tại Hàn Quốc","thai bang 2","02/04/2000"));
